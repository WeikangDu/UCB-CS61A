...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    temp1, temp2 = player_score % 100, opponent_score % 100
    player_score = abs(temp1 % 10 - temp1 // 10)
    opponent_score = abs(temp2 % 10 - temp2 // 10)
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    first_turn = True # Flag to mark which turn is for current
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    ...
    # BEGIN PROBLEM 6
        "*** YOUR CODE HERE ***"
        if first_turn:
            commentary_func = say(score0, score1)
            first_turn = False
        else:
            commentary_func = commentary_func(score0, score1)
    # END PROBLEM 6
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def highest_score(score0, score1):
        ...
        if who:
            ...
            score_care = score0
        score_diff = score_care - previous_score
        if score_diff > high_score:
            high_score = score_diff
            print(score_diff,
            "point(s)! That's the biggest gain yet for Player",who)
        return announce_highest(who, high_score, score_care)
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(score, opponent_score):
        ...
        if not is_swap(score, opponent_score):
            return 0
    return num_rolls
    # END PROBLEM 11
