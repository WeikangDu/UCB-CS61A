...
(quote (1 ((2 3)) 4 5 (6 7 8 8 . 9)))
; expect (1 ((2 3)) 4 5 (6 7 8 8 . 9))

(define alst (quote (1 ((2 3)) 4 5 (6 7 8 8 . 9))))
; expect alst

(car (cdr (car (car (cdr alst)))))
; expect 3

'(+ (- 5 2) 53)
; expect (+ (- 5 2) 53)

(begin (display (+ 2000 18)) (display 'Fall) (quote (CS 61a)))
; expect 2018fall(cs 61a)

(begin (define (f x) (* 3 x))
       (define (g y) (+ (f y) y))
       (f (g (f 2))))
; expect 72
...
(let ((a x)
      (b z))
      (list (+ b a) (* a b) x z))
; expect (1013 13000 13 1000)

(define f (mu (c) (+ (* x z) (* x c))))
; expect f

(f 66)
; expect 13858

(define g (lambda () (define x (+ x 1)) (define z (/ z 10)) (f 66)))
; expect g
