...
(define (longest-increasing-subsequence lst)
    (cond ((null? lst) nil)
    (else (begin
            (define with-first (cons (car lst) (longest-increasing-subsequence (filter (lambda (x) (> x (car lst))) (cdr lst)))))
            (define without-first (longest-increasing-subsequence (cdr lst)))
